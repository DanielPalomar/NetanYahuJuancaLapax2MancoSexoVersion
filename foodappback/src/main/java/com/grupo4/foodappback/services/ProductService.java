...
public class ProductService {
    ...
    // Actualizar un producto de la BD: solo puede actualizar su propietario o un admin: --- SOLO CAMBIAR NOMBRE, MARCA, CANTIDAD, FECHA ---
    public Product updateProduct(Long productId, Product p, Authentication authentication) {
        ...
        // CAMBIO: ahora se actualiza cantidad y fechaCaducidad en vez de weight
        product.setCantidad(p.getCantidad());
        product.setFechaCaducidad(p.getFechaCaducidad());
        // product.setWeight(p.getWeight());  // COMENTADO - campo eliminado de la BD  
     ...
     * COMENTADO - ya no se usa weight en la BD
     */
