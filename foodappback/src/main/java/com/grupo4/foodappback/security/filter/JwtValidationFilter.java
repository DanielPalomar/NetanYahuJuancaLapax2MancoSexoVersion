...
👉 Los guarda en el SecurityContext de Spring 
O sea, 👉 Convierte el token JWT en un usuario autenticado que Spring puede usar para autorizar la petición (con .authenticated y @PreAuthorize)*/
...
public class JwtValidationFilter extends BasicAuthenticationFilter {
    ...
    // Método principal del filtro: se ejecuta en CADA petición HTTP
     //Este filtro es el que convierte un token JWT en un usuario autenticado dentro de Spring
    @Override
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // SI NO HAY TOKEN o no empieza por "Bearer " → dejar pasar (Spring decidirá luego si bloquea)
        ...
        try {
            ...
            UsernamePasswordAuthenticationToken authToken =
             ...
             // GUARDAR AUTENTICACIÓN EN EL CONTEXTO DE SPRING - esto es lo que hace que Spring "sepa" quién se ha logueado
