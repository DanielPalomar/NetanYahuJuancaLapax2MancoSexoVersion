...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        // Leer username y password del request: puede venir como JSON (API) o como
        // form-data (formulario HTML)
        try {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        // Obtener usuario autenticado y su username: usamos directamente la clase
        // userdetails en lugar de instanciarla arriba
        org.springframework.security.core.userdetails.User user = (org.springframework.security.core.userdetails.User) authResult
                .getPrincipal();
        String username = user.getUsername();

        // Generar Map para construir el token JWT a partir del username anterior y de
        // los roles(authorities):
        ...
        if (request.getContentType() != null && request.getContentType().contains("application/json")) {
            ...
            // ==========================================================
            // MODIFICACIÓN TEMPORAL: Detectar admin para el frontend
            // Esto se puede borrar luego de las pruebas iniciales
            /*
             * Map<String, String> body = new HashMap<>();
             * body.put("token", token);
             * body.put("username", username);
             * body.put("message", "Hola " + username + ", has iniciado sesión con éxit!");
             */

            /* esto se borra despues de las pruebas */
            ...
            body.put("esAdministrador", isAdmin);
            // ==========================================================
            ...
            // Si la petición es Thymeleaf → poner el token en una cookie y ésta en la
            // response, y redirigir:
     ...
     * ===============================
     * POSTMAN:
     * - Si username/password incorrectos -> Respuesta HTTP 401 con un body de este
     * tipo:
     * {
