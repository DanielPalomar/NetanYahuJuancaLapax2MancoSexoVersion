...
function PanelAdmin() {
  ...
  for (let i = 0; i < usuarios.length; i++) {
    ...
    if (u.esAdministrador) {
      claseRol = 'px-2 py-1 text-xs font-bold bg-blue-200 text-blue-800 rounded';
      textoRol = 'Admin';
    }

    filasTabla.push(
      <tr key={u.id} className="border-b border-blue-200 hover:bg-blue-50">
  ...
  return (
    <div className="min-h-screen bg-blue-50 p-6 pb-24">
      <div className="max-w mx-auto">
        ...
        <div className="bg-white p-6 border border-blue-200 rounded mb-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 bg-white p-6 border border-blue-200 rounded self-start">
            ...
            <form onSubmit={agregarUsuario} className="space-y-3">
              ...
              <input type="text" required placeholder="Apellido" className="w-full px-3 py-2 border border-blue-200 rounded focus:outline-none focus:border-blue-500" value={nuevoApellido} onChange={function(e) { setNuevoApellido(e.target.value); }} />
              <input type="text" required placeholder="Usuario" className="w-full px-3 py-2 border border-blue-200 rounded focus:outline-none focus:border-blue-500" value={nuevoUsuario} onChange={function(e) { setNuevoUsuario(e.target.value); }} />
              <input type="email" required placeholder="Correo" className="w-full px-3 py-2 border border-blue-200 rounded focus:outline-none focus:border-blue-500" value={nuevoCorreo} onChange={function(e) { setNuevoCorreo(e.target.value); }} />
              <input type="password" required placeholder="Contraseña" className="w-full px-3 py-2 border border-blue-200 rounded focus:outline-none focus:border-blue-500" value={nuevaContraseña} onChange={function(e) { setNuevaContraseña(e.target.value); }} />
              <div className="flex items-center gap-2 p-3 border border-blue-200 rounded">
              ...
              <button type="submit" className="w-full bg-blue-600 text-white font-semibold py-2 rounded hover:bg-blue-700">Crear</button>
            </form>
          </div>
          ...
          <div className="flex-[2] bg-white border border-blue-200 rounded overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="text-xs font-bold text-slate-700 border-b border-blue-200 bg-blue-50">
