...
import { Plus, Calendar, Package, AlertTriangle, Search, ArrowUpDown } from 'lucide-react';
// import { serviciosAPI } from '../services/api';

// Página de la despensa - donde vemos todos los productos
const Despensa = () => {
  // Datos de productos (cuando conectemos Spring, vendrán del backend)
  ...
  //esto está mockeado para probar
  const [productos, setProductos] = useState([
    { id: 1, nombre: "Leche Entera", marca: "Pascual", caducidad: "2026-04-20", cantidad: 2, critico: false },
    { id: 2, nombre: "Yogur Griego", marca: "Danone", caducidad: "2026-04-16", cantidad: 4, critico: true },
    { id: 3, nombre: "Arroz", marca: "Sos", caducidad: "2027-12-01", cantidad: 1, critico: false },
  ]);

  // Estado para búsqueda
  const [busqueda, setBusqueda] = useState("");
  // Estado para ordenamiento: "caducidad", "nombre", "cantidad"
    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
          ...
          {/* Botón para ir a añadir producto */}
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-gray-600 group">
                  ...
                  <span className="text-sm">Caduca: <strong className={item.critico ? 'text-orange-600' : 'text-gray-800'}>{item.caducidad}</strong></span>
                </div>
                {/* Cantidad */}
